  ...
  return (
    <div className="group overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-blue-200 hover:shadow-lg">
        ...
        {image ? (
          ...
          <div className="flex h-full items-center justify-center">
            <div className="text-center !text-white">
              <div className="mx-auto mb-2 flex h-14 w-14 items-center justify-center rounded-xl bg-white/20 text-2xl font-bold !text-white backdrop-blur">
                {title.charAt(0)}
              </div>
      ...
      <div className="p-5">
        ...
        <Link
          to={`/courses/${id}`}
          className="mt-5 flex w-full items-center justify-center rounded-lg bg-blue-600 px-4 py-2.5 text-sm font-semibold !text-white transition-colors hover:bg-blue-700 hover:!text-white"
        >
          {progress !== undefined
            ? "Continue Learning"
            : "View Course"}
